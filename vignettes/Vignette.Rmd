...
This vignette gives an overview on function modalities provided in the R package SCIFER. SCIFER predicts variant accumulation in growing and homeostatic tissues that evolve neutrally or via clonal selection. Expected site frequency spectra can be assessed with analytical expressions or with stochastic simulations of variant accumulation. We will first compare the results of the analytical expressions and stochastic simulations. Second, we will introduce how SCIFER can be used for parameter estimation from real data.  

## Predict VAF distributions in neutrally evolving tissues with SCIFER
...
## Simulate VAF distributions in neutrally evolving tissues with SCIFER
...
## Predict VAF distributions in tissues with clonal selection with SCIFER
